=== FAQ by WD - Responsive FAQ plugin ===
Contributors: webdorado
Donate link: https://web-dorado.com/products/wordpress-faq-wd.html 
Tags: FAQ, FAQ Plugin, FAQs,wordpress faq, questions, answer, answers, helpdesk, help desk, frequently asked questions, faq page, FAQ widget 
...
FAQ WordPress plugin is designed for creating FAQ (Frequently Asked Questions) sections for your website.
...
Using the FAQ WD plugin you can create unlimited amount of questions and answers. The free FAQ plugin will allow you to assign questions and answers into categories. The accordion FAQ view will allow displaying only the questions thus saving space and allowing the user to navigate to the relevant question. To make the question search even more user -friendlier, it is possible to display a FAQ-specific search box. 
...
= The features of the FAQ WD plugin: =
...
== WORDPRESS FAQ WD STEP BY STEP GUIDE ==
...
After downloading the ZIP file of the FAQ WD plugin,  

1. Log in to the administrator panel.   
2. Go to Plugins Add > New > Upload.     
3. Click "Choose file" ("Browse") and select the downloaded zip file of the faq plugin.     
*For Mac Users*     
*Go to your Downloads folder and locate the folder with the FAQ WD. Right-click on the folder and select Compress. Now you have a newly created .zip file which can be installed as described here.*     
4. Click "Install Now" button.     
5. Click "Activate Plugin" button for activating the FAQ WD.    
...
WordPress FAQ WD allows you to reorder the categories. All you need to do is use the drag and drop option to easily order the FAQ categories. The options will be saved automatically.

THEMES
In this section of WordPress FAQ WD you can make changes to the default themes add create new themes (commercial version).

General Settings
The FAQ WD WordPress Plugins allows you to change options, such as search box, expand/collapse, read more and others. You can change the general width, text colors, font sizes and set margin.
...
Settings
There are a number of settings you can configure for WordPress FAQ WD. You can choose to display sharing, commenting options, as well as date and the number of views.
...
= 1.0.23 = 
Added: Search with autocomplete    
...
= 1.0.20 =
Fixed: Bug on search     
Fixed: Bug on question ordering         

= 1.0.19 =
Fixed: Bug on Shortcode   

= 1.0.18 =
Fixed: Bug on categories delete      
